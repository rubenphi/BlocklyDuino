/*
 * WitAITTS ESP32-C3 Basic Example
 * 
 * Text-to-Speech using Wit.ai API on ESP32-C3
 * 
 ...
 * 
 * Default I2S Connections (ESP32-C3):
 ...
 * MAX98357A GND  -> GND
 * 
 * Note: ESP32-C3 has limited GPIO (0-21). Default pins are 7, 6, 5.
 * 
 * Instructions:
 * 1. Update WiFi credentials below
 * 2. Get Wit.ai token from https://wit.ai
 * 3. Select "ESP32C3 Dev Module" in Arduino IDE
 * 4. Upload sketch
...
// I2S Pins (default for ESP32-C3: BCLK=7, LRC=6, DIN=5)
...
// Create TTS object with default pins (7, 6, 5 for C3)
WitAITTS tts;
...
void setup() {
    ...
    Serial.println("\n\n========================================");
    Serial.println("   WitAITTS ESP32-C3 Basic Example");
