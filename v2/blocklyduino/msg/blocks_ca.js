...
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_INPUT = "el valor del sensor tàctil capacitiu al pin";
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_TOOLTIP = "llegeix el valor del sensor tàctil capacitiu del pin tàctil de l'ESP32 indicat (touchRead).";
