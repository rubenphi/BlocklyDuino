...
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_INPUT = "read capacitive touch value on pin";
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_TOOLTIP = "Reads the capacitive touch sensor value on the given ESP32 touch pin (touchRead).";
