...
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_INPUT = "el valor del sensor táctil capacitivo en el pin";
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_TOOLTIP = "lee el valor del sensor táctil capacitivo del pin táctil del ESP32 indicado (touchRead).";
...
Blockly.Msg.ARDUINO_SETUP_TOOLTIP = "El codigo colocado aqui se ejecuta una vez cuando el Arduino arranca";
...
Blockly.Msg.ARDUINO_LOOP_TOOLTIP = "El codigo colocado aqui se ejecuta repetidamente en un bucle";
