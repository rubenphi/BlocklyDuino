...
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_INPUT = "タッチセンサーの値をピンから読み取る";
Blockly.Msg.ARDUINO_INOUT_CAPACITIVE_READ_TOOLTIP = "指定したESP32タッチピンの静電容量タッチセンサー値を読み取ります（touchRead）。";
